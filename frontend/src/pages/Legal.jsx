    ...
    <div className="min-h-screen bg-slate-950 text-slate-300 p-8 md:p-20 font-sans leading-relaxed">
      <div className="max-w-3xl mx-auto">
        ...
        <footer className="mt-12 text-slate-600 text-sm border-t border-white/5 pt-8">
          <p>&copy; {new Date().getFullYear()} MK FOOD CORNER. All rights reserved.</p>
        </footer>
      </div>
    </div>
  );
...
export const PrivacyPolicy = () => (
  <LegalLayout title="Privacy Policy">
    <div className="space-y-6">
      <p>Your privacy is important to us. This Privacy Policy explains how MK FOOD CORNER collects, uses, and protects your personal information when you use our multi-tenant POS platform.</p>
...
export const TermsOfService = () => (
  <LegalLayout title="Terms of Service">
    <div className="space-y-6">
      <p>By using the MK FOOD CORNER system, you agree to comply with and be bound by the following terms and conditions.</p>
      ...
      <section>
        ...
        <p>MK FOOD CORNER is provided "as is" and we are not liable for any damages resulting from the use or inability to use our platform.</p>
      </section>
    </div>
  </LegalLayout>
);
...
export const DataDeletion = () => (
  <LegalLayout title="Store Conditions">
    <div className="space-y-6">
      <p>We respect your right to control your personal data. If you wish to delete your MK FOOD CORNER account and all associated data, please follow these instructions:</p>
